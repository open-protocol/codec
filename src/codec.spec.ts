...
test("encode and decode test", () => {
  ...
  expect(encoded.toString("hex")).toBe(
    "020100010201000202010001010100020201000002010001"
  );
...
test("array encode test", () => {
  ...
  expect(encoded.toString("hex")).toBe(
    "03300000000220007e9cd855ddb203964649da096ebba0515070db91a0bfcba96e4f692ad582f2dc020100ff020200ffff01010064"
  );
});
...
test("map encode test", () => {
  ...
  expect(encoded.toString("hex")).toBe(
    "04380000000201000002010001020100010220007e9cd855ddb203964649da096ebba0515070db91a0bfcba96e4f692ad582f2dc02010002020200ffff"
  );
});
